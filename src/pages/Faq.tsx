const faqs = [
  ...
  },
  {
    ...
    answer: 'Due to limited space, we can only accommodate guests whose names appear on the invitation. Please check your RSVP for the names included in your party.',
  },
  {
