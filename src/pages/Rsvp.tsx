    ...
    return (
        <main className="main-content">
            ...
            <div className="wedding-img">
                <img src={"/assets/engagement/IMG_12.jpg"} alt={"kalyn and jack with 'click us to view registry' text"} />
            </div>

            <p className="details" style={{ margin: '1.5rem 0' }}>
                The deadline to RSVP has passed. We are so excited to celebrate with those who have responded! If you have any questions, please reach out to us directly.
            </p>
